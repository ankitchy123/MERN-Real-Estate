            ...
            <div  className="flex flex-col gap-4 flex-1">
                ...
                <div className="flex flex-wrap gap-6">
                    <div className="flex items-center gap-2">
                        <input type="number" id="bedrooms" min='1' max='10' required className="p-3 border border-gray-300 rounded-lg" defaultValue={1}/>
                        <p>Beds</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <input type="number" id="bathrooms" min='1' max='10' required className="p-3 border border-gray-300 rounded-lg" defaultValue={1}/>
                        <p>Baths</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <input type="number" id="regularPrice" min='50' max='10000000' required className="p-3 border border-gray-300 rounded-lg" defaultValue={1}/>
                    ...
                    <div className="flex items-center gap-2">
                        <input type="number" id="discountPrice" min='0' max='10000000' required className="p-3 border border-gray-300 rounded-lg" defaultValue={1}/>
                        <div className="flex flex-col items-center">
