...
export default function Profile() {
  ...
  const [updateSucsess, setUpdateSuccess] = useState(false)
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <p className='text-green-700 mt-5'>{updateSucsess ? 'Profile updated successfully!' : ''}</p>
      ...
      {userListings.length > 0 &&
        <div className='flex flex-col gap-4'>
          ...
          <div key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4'>
            ...
            <Link className='text-slate-700 font-semibold hover:underline truncate hover:cursor-pointer flex-1' to={`/listing/${listing._id}`}>
              <p>{listing.name}</p>
            </Link>
