  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            ...
            <button disabled={loading || uploading} className="p-3 bg-slate-700 text-white rounded-lg hover:opacity-95 disabled:opacity-80 disabled:cursor-not-allowed">{loading ? 'UPDATING...' : 'UPDATE LISTING'}</button>
