  ...
  return (
    ...
    {landlord && (
        <div className='flex flex-col gap-2'>
            ...
            <textarea className='w-full border p-3 rounded-lg' name="message" id="message" rows="10" placeholder='Write your message here...' value={message} onChange={handleChange}></textarea>
